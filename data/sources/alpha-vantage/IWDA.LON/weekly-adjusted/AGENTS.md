# IWDA.LON Alpha Vantage Weekly Adjusted Snapshot

This directory contains a manually fetched Alpha Vantage `TIME_SERIES_WEEKLY_ADJUSTED` snapshot for `IWDA.LON`. The current snapshot covers 2009-10-20 through 2026-07-06 with 853 weekly rows.
